    ...
    public function up()
    {
        if ($this->useBigIncrements) {
            Schema::create('groups', function (Blueprint $table) {
                ...
                $table->integer('user_id')->unsignedintegers();
            ...
            Schema::create('group_user', function (Blueprint $table) {
                ...
                $table->integer('user_id')->unsignedintegers();
                $table->integer('group_id')->unsignedintegers();
                $table->timestamps();
            ...
            Schema::create('group_post', function (Blueprint $table) {
                $table->integer('group_id')->unsignedintegers();
                $table->integer('post_id')->unsignedintegers();
                $table->timestamps();
            ...
            Schema::create('group_request', function (Blueprint $table) {
                $table->bigIncrements('id');
                $table->integer('user_id')->unsignedintegers()->index();
                $table->integer('group_id')->unsignedintegers()->index();
                $table->timestamps();
